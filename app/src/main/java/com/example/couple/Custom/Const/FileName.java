...
public class FileName {
    ...
    public static final String DATE_TIME = "date_time.txt";
    public static final String DATE_DATA_NEXT_DAY = "date_data_next_day.txt";
    public static final String DATE_DATA_TODAY = "date_data_today.txt";
