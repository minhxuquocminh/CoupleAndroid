...
public class AfterDoubleBridge {
    ...
    public AfterDoubleBridge(List<Couple> lastDoubleRange, int dayNumberBefore) {
        ...
        if (lastDoubleRange.size() >= 3) {
            ...
            this.setMap.put(1, NumberSet.getFrom(firstCouple.getCoupleInt()));
            ...
            this.setMap.put(3, NumberSet.getFrom(thirdCouple));
            this.setMap.put(4, NumberSet.getFrom(fourthCouple));
            if (lastDoubleRange.size() >= 4) {
                ...
                this.setMap.put(2, NumberSet.getFrom(secondCouple.getCoupleInt()));
            }
        }
